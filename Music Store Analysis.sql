...
--write a query that returns one city that has highest sum of invoice totals.Return both the city name & sum of all 
-- invoice totals?
...
-- Q5 Who is the best customer? customer who spend the most money will be declared the best customer.
...
-- Return the name and milliseconds for each track. Order by the song length will the longest songs listed first.
...
SELECT name,milliseconds 
FROM track 
WHERE milliseconds > 393599 -- we took out the avg of milliseconds
ORDER BY milliseconds DESC;

-- Q9 Find out how much amount spent by each customer on artists? Write a query to return customer name,artist name 
-- and total spent.
